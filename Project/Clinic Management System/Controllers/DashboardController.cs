...
namespace Clinic_Management_System.Controllers
{
    public class DashboardController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Admin_Create(Admin a,HttpPostedFileBase img)
        {
            String imgUrl = "";
            if (ModelState.IsValid)
            {
                ...
                {
                    img.SaveAs(Server.MapPath("~/A_Images/" + img.FileName));
                    imgUrl = "~/A_Images/" + img.FileName;
        ...
        [HttpPost]
        public ActionResult Admin_Edit(Admin a,HttpPostedFileBase img)
        {
            String imgUrl = "";
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        public ActionResult Products_Create(Product p,HttpPostedFileBase img)
        {
            String imgUrl = "";
            ...
            if (ModelState.IsValid)
            {
                if (img.ContentLength > 0)
                {
                    img.SaveAs(Server.MapPath("~/P_Images/" + img.FileName));
                    imgUrl = "~/P_Images/" + img.FileName;
                    img.InputStream.Close();
                    img.InputStream.Dispose();
                }
        ...
        [HttpPost]
        public ActionResult Products_Edit(Product p,HttpPostedFileBase img)
        {
            if (ModelState.IsValid)
            {
                String imgUrl = "";
        ...
        [HttpPost]
        public ActionResult Staff_Create(Staff a,HttpPostedFileBase img)
        {
            ...
            if (ModelState.IsValid)
            {
                if (img.ContentLength > 0)
                {
                    img.SaveAs(Server.MapPath("~/S_Images/" + img.FileName));
                    imgUrl = "~/S_Images/" + img.FileName;
                    img.InputStream.Close();
                    img.InputStream.Dispose();
                    //Response.Write("<Script>alert('failed')</Script>");
                }
        ...
        [HttpPost]
        public ActionResult Staff_Edit(Staff e,HttpPostedFileBase img)
        {
            String imgUrl = "";
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        public ActionResult Admin_Image_Create(Admin c, HttpPostedFileBase img)
        {
        ...
        {
            var x = db.Admins.Find(id);
            return View(x);
        }


        [HttpPost]
        public ActionResult Edit(Admin c, HttpPostedFileBase img)
        {
            String imgUrl = "";
            if (img.ContentLength > 0)
            {
